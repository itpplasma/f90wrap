...
class Class_Example(f90wrap.runtime.FortranModule):
    ...
    class Example(f90wrap.runtime.FortranDerivedType):
        ...
        def first(self):
            ...
            Defined at example.fpp line 14
            """
            return _example.f90wrap_class_example__example__get__first(self._handle)
        
        @first.setter
        def first(self, first):
            _example.f90wrap_class_example__example__set__first(self._handle, first)
        
        @property
        def second(self):
            """
            Element second ftype=integer  pytype=int
            Defined at example.fpp line 15
            """
            return _example.f90wrap_class_example__example__get__second(self._handle)
        
        @second.setter
        def second(self, second):
            _example.f90wrap_class_example__example__set__second(self._handle, second)
        
        @property
        def third(self):
            """
            Element third ftype=integer  pytype=int
            Defined at example.fpp line 16
            """
            return _example.f90wrap_class_example__example__get__third(self._handle)
        
        @third.setter
        def third(self, third):
            _example.f90wrap_class_example__example__set__third(self._handle, third)
    ...
    def return_example_first(first, interface_call=False):
        ...
        Defined at example.fpp lines 22-28
    ...
    def return_example_second(first, second, interface_call=False):
        ...
        Defined at example.fpp lines 31-39
    ...
    def return_example_third(first, second, third, interface_call=False):
        ...
        Defined at example.fpp lines 42-52
    ...
    def return_example(*args, **kwargs):
        ...
        Defined at example.fpp lines 10-11
        ...
        """
        for proc in [Class_Example.return_example_first, \
            Class_Example.return_example_second, Class_Example.return_example_third]:
            exception=None
            try:
