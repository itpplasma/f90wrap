...
class Example(f90wrap.runtime.FortranDerivedType):
    ...
    def first(self):
        ...
        """
        return _examplepkg.f90wrap_class_example__example__get__first(self._handle)
    
    @first.setter
    def first(self, first):
        _examplepkg.f90wrap_class_example__example__set__first(self._handle, first)
    ...
    def second(self):
        ...
        """
        return _examplepkg.f90wrap_class_example__example__get__second(self._handle)
    
    @second.setter
    def second(self, second):
        _examplepkg.f90wrap_class_example__example__set__second(self._handle, second)
    ...
    def third(self):
        ...
        """
        return _examplepkg.f90wrap_class_example__example__get__third(self._handle)
    
    @third.setter
    def third(self, third):
        _examplepkg.f90wrap_class_example__example__set__third(self._handle, third)
...
def return_example(*args, **kwargs):
    ...
    """
    for proc in [return_example_first, return_example_second, return_example_third]:
        exception=None
        try:
