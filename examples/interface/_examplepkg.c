...
/* Method table for _examplepkg module */
static PyMethodDef _examplepkg_methods[] = {
...
static struct PyModuleDef _examplepkgmodule = {
    PyModuleDef_HEAD_INIT,
    "examplepkg",
    "Direct-C wrapper for _examplepkg module",
    -1,
    _examplepkg_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__examplepkg(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_examplepkgmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
