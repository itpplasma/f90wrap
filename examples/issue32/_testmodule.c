 ...
 * Generation date: Tue Oct 21 20:18:50 2025
...
/* See f2py2e/rules.py */
extern void F_FUNC_US(f90wrap_foo,F90WRAP_FOO)(double*,int*);
/*eof externroutines*/
...
/******************************** f90wrap_foo ********************************/
static char doc_f2py_rout__test_f90wrap_foo[] = "\
f90wrap_foo(a,b)\n\nWrapper for ``f90wrap_foo``.\
\n\nParameters\n----------\n"
"a : input float\n"
"b : input int";
/* extern void F_FUNC_US(f90wrap_foo,F90WRAP_FOO)(double*,int*); */
static PyObject *f2py_rout__test_f90wrap_foo(const PyObject *capi_self,
                           PyObject *capi_args,
...
f2py_start_clock();
    ...
    if (!PyArg_ParseTupleAndKeywords(capi_args,capi_keywds,\
        "OO|:_test.f90wrap_foo",\
        capi_kwlist,&a_capi,&b_capi))
        return NULL;
/*frompyobj*/
    /* Processing variable a */
        f2py_success = double_from_pyobj(&a,a_capi,"_test.f90wrap_foo() 1st argument (a) can't be converted to double");
    if (f2py_success) {
    /* Processing variable b */
        f2py_success = int_from_pyobj(&b,b_capi,"_test.f90wrap_foo() 2nd argument (b) can't be converted to int");
    if (f2py_success) {
/*end of frompyobj*/
#ifdef F2PY_REPORT_ATEXIT
...
static FortranDataDef f2py_routine_defs[] = {
    {"f90wrap_foo",-1,{{-1}},0,0,(char *)  F_FUNC_US(f90wrap_foo,F90WRAP_FOO),  (f2py_init_func)f2py_rout__test_f90wrap_foo,doc_f2py_rout__test_f90wrap_foo},
