...
/* Method table for _ExampleRecursive module */
static PyMethodDef _ExampleRecursive_methods[] = {
...
static struct PyModuleDef _ExampleRecursivemodule = {
    PyModuleDef_HEAD_INIT,
    "ExampleRecursive",
    "Direct-C wrapper for _ExampleRecursive module",
    -1,
    _ExampleRecursive_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__ExampleRecursive(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_ExampleRecursivemodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
