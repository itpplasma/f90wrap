...
/* Method table for _CBF_pkg module */
static PyMethodDef _CBF_pkg_methods[] = {
...
static struct PyModuleDef _CBF_pkgmodule = {
    PyModuleDef_HEAD_INIT,
    "CBF_pkg",
    "Direct-C wrapper for _CBF_pkg module",
    -1,
    _CBF_pkg_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__CBF_pkg(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_CBF_pkgmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
