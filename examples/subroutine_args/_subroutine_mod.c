...
/* Method table for _subroutine_mod module */
static PyMethodDef _subroutine_mod_methods[] = {
...
static struct PyModuleDef _subroutine_modmodule = {
    PyModuleDef_HEAD_INIT,
    "subroutine_mod",
    "Direct-C wrapper for _subroutine_mod module",
    -1,
    _subroutine_mod_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__subroutine_mod(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_subroutine_modmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
