...
class Module_Calcul(f90wrap.runtime.FortranModule):
    ...
    class type_ptmes(f90wrap.runtime.FortranDerivedType):
        ...
        def y(self):
            ...
            """
            return _arrayderivedtype.f90wrap_module_calcul__type_ptmes__get__y(self._handle)
        
        @y.setter
        def y(self, y):
            _arrayderivedtype.f90wrap_module_calcul__type_ptmes__set__y(self._handle, y)
    ...
    class array_type(f90wrap.runtime.FortranDerivedType):
        ...
        def init_array_x(self):
            self.x = f90wrap.runtime.FortranDerivedTypeArray(self,
                                                _arrayderivedtype.f90wrap_module_calcul__array_type__array_getitem__x,
                                                _arrayderivedtype.f90wrap_module_calcul__array_type__array_setitem__x,
                                                _arrayderivedtype.f90wrap_module_calcul__array_type__array_len__x,
                                                """
