...
/* Method table for _ExampleStrings module */
static PyMethodDef _ExampleStrings_methods[] = {
...
static struct PyModuleDef _ExampleStringsmodule = {
    PyModuleDef_HEAD_INIT,
    "ExampleStrings",
    "Direct-C wrapper for _ExampleStrings module",
    -1,
    _ExampleStrings_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__ExampleStrings(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_ExampleStringsmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
