...
static PyObject* wrap__mockdtpkg_set_defaults(PyObject* self, PyObject* args, PyObject* kwargs)
{
...
static PyObject* wrap__mockdtpkg_assign_constants(PyObject* self, PyObject* args, PyObject* kwargs)
{
    /* Call f90wrap helper */
...
/* Method table for _mockdtpkg module */
static PyMethodDef _mockdtpkg_methods[] = {
    ...
    {"f90wrap_set_defaults", (PyCFunction)wrap__mockdtpkg_set_defaults, METH_VARARGS | METH_KEYWORDS, \
        "======================================================================="},
    {"f90wrap_assign_constants", (PyCFunction)wrap__mockdtpkg_assign_constants, METH_VARARGS | METH_KEYWORDS, \
        "======================================================================="},
...
static struct PyModuleDef _mockdtpkgmodule = {
    PyModuleDef_HEAD_INIT,
    "mockdtpkg",
    "Direct-C wrapper for _mockdtpkg module",
    -1,
    _mockdtpkg_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__mockdtpkg(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_mockdtpkgmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
