...
class Defineallproperties(f90wrap.runtime.FortranModule):
    ...
    class SolverOptionsDef(f90wrap.runtime.FortranDerivedType):
        ...
        def trimswitch(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__trimswitch(self._handle)
        
        @trimswitch.setter
        def trimswitch(self, trimswitch):
            _mockdt.f90wrap_solveroptionsdef__set__trimswitch(self._handle, trimswitch)
        ...
        def updateguess(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 24
            """
            return _mockdt.f90wrap_solveroptionsdef__get__updateguess(self._handle)
        
        @updateguess.setter
        def updateguess(self, updateguess):
            _mockdt.f90wrap_solveroptionsdef__set__updateguess(self._handle, updateguess)
        ...
        def deltaairloads(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 24
            """
            return _mockdt.f90wrap_solveroptionsdef__get__deltaairloads(self._handle)
        
        @deltaairloads.setter
        def deltaairloads(self, deltaairloads):
            _mockdt.f90wrap_solveroptionsdef__set__deltaairloads(self._handle, \
                deltaairloads)
        ...
        def linrzswitch(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__linrzswitch(self._handle)
        
        @linrzswitch.setter
        def linrzswitch(self, linrzswitch):
            _mockdt.f90wrap_solveroptionsdef__set__linrzswitch(self._handle, linrzswitch)
        ...
        def timemarchswitch(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__timemarchswitch(self._handle)
        
        @timemarchswitch.setter
        def timemarchswitch(self, timemarchswitch):
            _mockdt.f90wrap_solveroptionsdef__set__timemarchswitch(self._handle, \
                timemarchswitch)
        ...
        def freewakeswitch(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__freewakeswitch(self._handle)
        
        @freewakeswitch.setter
        def freewakeswitch(self, freewakeswitch):
            _mockdt.f90wrap_solveroptionsdef__set__freewakeswitch(self._handle, \
                freewakeswitch)
        ...
        def windtunnelswitch(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__windtunnelswitch(self._handle)
        
        @windtunnelswitch.setter
        def windtunnelswitch(self, windtunnelswitch):
            _mockdt.f90wrap_solveroptionsdef__set__windtunnelswitch(self._handle, \
                windtunnelswitch)
        ...
        def rigidbladeswitch(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__rigidbladeswitch(self._handle)
        
        @rigidbladeswitch.setter
        def rigidbladeswitch(self, rigidbladeswitch):
            _mockdt.f90wrap_solveroptionsdef__set__rigidbladeswitch(self._handle, \
                rigidbladeswitch)
        ...
        def fet_qddot(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__fet_qddot(self._handle)
        
        @fet_qddot.setter
        def fet_qddot(self, fet_qddot):
            _mockdt.f90wrap_solveroptionsdef__set__fet_qddot(self._handle, fet_qddot)
        ...
        def fet_response(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 30
            """
            return _mockdt.f90wrap_solveroptionsdef__get__fet_response(self._handle)
        
        @fet_response.setter
        def fet_response(self, fet_response):
            _mockdt.f90wrap_solveroptionsdef__set__fet_response(self._handle, fet_response)
        ...
        def store_fet_responsejac(self):
            ...
            """
            return \
                _mockdt.f90wrap_solveroptionsdef__get__store_fet_responsejac(self._handle)
        
        @store_fet_responsejac.setter
        def store_fet_responsejac(self, store_fet_responsejac):
            _mockdt.f90wrap_solveroptionsdef__set__store_fet_responsejac(self._handle, \
        ...
        def fet_responsejacavail(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 31
            """
            return _mockdt.f90wrap_solveroptionsdef__get__fet_responsejacavail(self._handle)
        
        @fet_responsejacavail.setter
        def fet_responsejacavail(self, fet_responsejacavail):
            _mockdt.f90wrap_solveroptionsdef__set__fet_responsejacavail(self._handle, \
        ...
        def airframevib(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__airframevib(self._handle)
        
        @airframevib.setter
        def airframevib(self, airframevib):
            _mockdt.f90wrap_solveroptionsdef__set__airframevib(self._handle, airframevib)
        ...
        def fusharm(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 32
            """
            return _mockdt.f90wrap_solveroptionsdef__get__fusharm(self._handle)
        
        @fusharm.setter
        def fusharm(self, fusharm):
            _mockdt.f90wrap_solveroptionsdef__set__fusharm(self._handle, fusharm)
        ...
        def axialdof(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__axialdof(self._handle)
        
        @axialdof.setter
        def axialdof(self, axialdof):
            _mockdt.f90wrap_solveroptionsdef__set__axialdof(self._handle, axialdof)
        ...
        def composite_coupling(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 33
            """
            return _mockdt.f90wrap_solveroptionsdef__get__composite_coupling(self._handle)
        
        @composite_coupling.setter
        def composite_coupling(self, composite_coupling):
            _mockdt.f90wrap_solveroptionsdef__set__composite_coupling(self._handle, \
                composite_coupling)
        ...
        def trimtechnique(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__trimtechnique(self._handle)
        
        @trimtechnique.setter
        def trimtechnique(self, trimtechnique):
            _mockdt.f90wrap_solveroptionsdef__set__trimtechnique(self._handle, \
                trimtechnique)
        ...
        def trimsweepoption(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__trimsweepoption(self._handle)
        
        @trimsweepoption.setter
        def trimsweepoption(self, trimsweepoption):
            _mockdt.f90wrap_solveroptionsdef__set__trimsweepoption(self._handle, \
                trimsweepoption)
        ...
        def ntimeelements(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 35
            """
            return _mockdt.f90wrap_solveroptionsdef__get__ntimeelements(self._handle)
        
        @ntimeelements.setter
        def ntimeelements(self, ntimeelements):
            _mockdt.f90wrap_solveroptionsdef__set__ntimeelements(self._handle, \
                ntimeelements)
        ...
        def nbladeharm(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nbladeharm(self._handle)
        
        @nbladeharm.setter
        def nbladeharm(self, nbladeharm):
            _mockdt.f90wrap_solveroptionsdef__set__nbladeharm(self._handle, nbladeharm)
        ...
        def nblademodes(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 36
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nblademodes(self._handle)
        
        @nblademodes.setter
        def nblademodes(self, nblademodes):
            _mockdt.f90wrap_solveroptionsdef__set__nblademodes(self._handle, nblademodes)
        ...
        def modeorder(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _mockdt.f90wrap_solveroptionsdef__array__modeorder(self._handle)
            array_hash = hash((array_ndim, array_type, tuple(array_shape), array_handle))
            if array_hash in self._arrays:
                ...
                try:
                    modeorder = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                            self._handle,
                                            _mockdt.f90wrap_solveroptionsdef__array__modeorder)
                except TypeError:
        ...
        def ncosinflowharm(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__ncosinflowharm(self._handle)
        
        @ncosinflowharm.setter
        def ncosinflowharm(self, ncosinflowharm):
            _mockdt.f90wrap_solveroptionsdef__set__ncosinflowharm(self._handle, \
                ncosinflowharm)
        ...
        def nmaxinflowpoly(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 38
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nmaxinflowpoly(self._handle)
        
        @nmaxinflowpoly.setter
        def nmaxinflowpoly(self, nmaxinflowpoly):
            _mockdt.f90wrap_solveroptionsdef__set__nmaxinflowpoly(self._handle, \
                nmaxinflowpoly)
        ...
        def linflm(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 38
            """
            return _mockdt.f90wrap_solveroptionsdef__get__linflm(self._handle)
        
        @linflm.setter
        def linflm(self, linflm):
            _mockdt.f90wrap_solveroptionsdef__set__linflm(self._handle, linflm)
        ...
        def linrzpts(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__linrzpts(self._handle)
        
        @linrzpts.setter
        def linrzpts(self, linrzpts):
            _mockdt.f90wrap_solveroptionsdef__set__linrzpts(self._handle, linrzpts)
        ...
        def controlhistoption(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__controlhistoption(self._handle)
        
        @controlhistoption.setter
        def controlhistoption(self, controlhistoption):
            _mockdt.f90wrap_solveroptionsdef__set__controlhistoption(self._handle, \
                controlhistoption)
        ...
        def nrevolutions(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 40
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nrevolutions(self._handle)
        
        @nrevolutions.setter
        def nrevolutions(self, nrevolutions):
            _mockdt.f90wrap_solveroptionsdef__set__nrevolutions(self._handle, nrevolutions)
        ...
        def nazim(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 40
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nazim(self._handle)
        
        @nazim.setter
        def nazim(self, nazim):
            _mockdt.f90wrap_solveroptionsdef__set__nazim(self._handle, nazim)
        ...
        def ntimesteps(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__ntimesteps(self._handle)
        
        @ntimesteps.setter
        def ntimesteps(self, ntimesteps):
            _mockdt.f90wrap_solveroptionsdef__set__ntimesteps(self._handle, ntimesteps)
        ...
        def nred(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nred(self._handle)
        
        @nred.setter
        def nred(self, nred):
            _mockdt.f90wrap_solveroptionsdef__set__nred(self._handle, nred)
        ...
        def nred2(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 42
            """
            return _mockdt.f90wrap_solveroptionsdef__get__nred2(self._handle)
        
        @nred2.setter
        def nred2(self, nred2):
            _mockdt.f90wrap_solveroptionsdef__set__nred2(self._handle, nred2)
        ...
        def trimconvergence(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__trimconvergence(self._handle)
        
        @trimconvergence.setter
        def trimconvergence(self, trimconvergence):
            _mockdt.f90wrap_solveroptionsdef__set__trimconvergence(self._handle, \
                trimconvergence)
        ...
        def integerror(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 43
            """
            return _mockdt.f90wrap_solveroptionsdef__get__integerror(self._handle)
        
        @integerror.setter
        def integerror(self, integerror):
            _mockdt.f90wrap_solveroptionsdef__set__integerror(self._handle, integerror)
        ...
        def linrzpert(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__linrzpert(self._handle)
        
        @linrzpert.setter
        def linrzpert(self, linrzpert):
            _mockdt.f90wrap_solveroptionsdef__set__linrzpert(self._handle, linrzpert)
        ...
        def controlamplitude(self):
            ...
            """
            return _mockdt.f90wrap_solveroptionsdef__get__controlamplitude(self._handle)
        
        @controlamplitude.setter
        def controlamplitude(self, controlamplitude):
            _mockdt.f90wrap_solveroptionsdef__set__controlamplitude(self._handle, \
                controlamplitude)
        ...
        def controlfrequency(self):
            ...
            Defined at ../Source/BasicDefs/aa2_defineAllProperties.fpp line 45
            """
            return _mockdt.f90wrap_solveroptionsdef__get__controlfrequency(self._handle)
        
        @controlfrequency.setter
        def controlfrequency(self, controlfrequency):
            _mockdt.f90wrap_solveroptionsdef__set__controlfrequency(self._handle, \
                controlfrequency)
        ...
        def jac(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _mockdt.f90wrap_solveroptionsdef__array__jac(self._handle)
            array_hash = hash((array_ndim, array_type, tuple(array_shape), array_handle))
            if array_hash in self._arrays:
                ...
                try:
                    jac = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                            self._handle,
                                            _mockdt.f90wrap_solveroptionsdef__array__jac)
                except TypeError:
        ...
        def jac2(self):
            ...
            """
            array_ndim, array_type, array_shape, array_handle = \
                _mockdt.f90wrap_solveroptionsdef__array__jac2(self._handle)
            array_hash = hash((array_ndim, array_type, tuple(array_shape), array_handle))
            if array_hash in self._arrays:
                ...
                try:
                    jac2 = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                            self._handle,
                                            _mockdt.f90wrap_solveroptionsdef__array__jac2)
                except TypeError:
