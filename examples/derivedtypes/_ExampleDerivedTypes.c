...
/* Method table for _ExampleDerivedTypes module */
static PyMethodDef _ExampleDerivedTypes_methods[] = {
...
static struct PyModuleDef _ExampleDerivedTypesmodule = {
    PyModuleDef_HEAD_INIT,
    "ExampleDerivedTypes",
    "Direct-C wrapper for _ExampleDerivedTypes module",
    -1,
    _ExampleDerivedTypes_methods
};
...
PyMODINIT_FUNC PyInit__ExampleDerivedTypes(void)
{
    ...
    PyObject* module = PyModule_Create(&_ExampleDerivedTypesmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
