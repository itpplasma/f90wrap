...
extern void F90WRAP_F_SYMBOL(f90wrap_othertype_mod__constructor)(int* ret_obj);
extern void F90WRAP_F_SYMBOL(f90wrap_othertype_mod__plus_b)(int* obj, int* b, int* c);
extern void F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype_initialise)(int* this);
extern void F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype_finalise)(int* this);
extern void F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype__get__a)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype__set__a)(int* handle, int* value);

static PyObject* wrap_othertype_mod_constructor(PyObject* self, PyObject* args, PyObject* kwargs)
{
    int ret_obj[4] = {0};
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_othertype_mod__constructor)(ret_obj);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_othertype_mod_plus_b(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_othertype_mod__plus_b)(obj, b, &c_val);
    if (PyErr_Occurred()) {
...
static PyObject* wrap_othertype_mod_othertype_initialise(PyObject* self, PyObject* args, PyObject* kwargs)
{
    int this[4] = {0};
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype_initialise)(this);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_othertype_mod_othertype_finalise(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype_finalise)(this);
    if (this_sequence) {
        Py_DECREF(this_sequence);
    }
    if (this_handle_obj) {
...
static PyObject* wrap_othertype_mod__othertype_helper_get_a(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    ...
    Py_DECREF(handle_sequence);
    int value;
    F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype__get__a)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_othertype_mod__othertype_helper_set_a(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    int value;
    ...
    Py_DECREF(handle_sequence);
    F90WRAP_F_SYMBOL(f90wrap_othertype_mod__othertype__set__a)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
    Py_RETURN_NONE;
...
/* Method table for _othertype module */
static PyMethodDef _othertype_methods[] = {
    {"f90wrap_othertype_mod__constructor", (PyCFunction)wrap_othertype_mod_constructor, METH_VARARGS | METH_KEYWORDS, \
        "Wrapper for constructor"},
    {"f90wrap_othertype_mod__plus_b", (PyCFunction)wrap_othertype_mod_plus_b, METH_VARARGS | METH_KEYWORDS, "Wrapper for \
        plus_b"},
    {"f90wrap_othertype_mod__othertype_initialise", (PyCFunction)wrap_othertype_mod_othertype_initialise, METH_VARARGS | \
        METH_KEYWORDS, "Automatically generated constructor for othertype"},
    {"f90wrap_othertype_mod__othertype_finalise", (PyCFunction)wrap_othertype_mod_othertype_finalise, METH_VARARGS | \
        METH_KEYWORDS, "Automatically generated destructor for othertype"},
    {"f90wrap_othertype_mod__othertype__get__a", (PyCFunction)wrap_othertype_mod__othertype_helper_get_a, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for a"},
    {"f90wrap_othertype_mod__othertype__set__a", (PyCFunction)wrap_othertype_mod__othertype_helper_set_a, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for a"},
    {NULL, NULL, 0, NULL}  /* Sentinel */
};

static struct PyModuleDef _othertypemodule = {
    PyModuleDef_HEAD_INIT,
    "othertype",
    "Direct-C wrapper for _othertype module",
    -1,
    _othertype_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__othertype(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_othertypemodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
