...
extern void F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face_initialise)(int* this);
extern void F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face_finalise)(int* this);
extern void F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face__get__type_bn)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face__set__type_bn)(int* handle, int* value);

static PyObject* wrap_module_structure_type_face_initialise(PyObject* self, PyObject* args, PyObject* kwargs)
{
    int this[4] = {0};
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face_initialise)(this);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_module_structure_type_face_finalise(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face_finalise)(this);
    if (this_sequence) {
        Py_DECREF(this_sequence);
    }
    if (this_handle_obj) {
...
static PyObject* wrap_module_structure__type_face_helper_get_type_bn(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    ...
    Py_DECREF(handle_sequence);
    int value;
    F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face__get__type_bn)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_module_structure__type_face_helper_set_type_bn(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    int value;
    static char *kwlist[] = {"handle", "type_bn", NULL};
    ...
    Py_DECREF(handle_sequence);
    F90WRAP_F_SYMBOL(f90wrap_module_structure__type_face__set__type_bn)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
    Py_RETURN_NONE;
...
/* Method table for _type_bn module */
static PyMethodDef _type_bn_methods[] = {
    {"f90wrap_module_structure__type_face_initialise", (PyCFunction)wrap_module_structure_type_face_initialise, METH_VARARGS \
        | METH_KEYWORDS, "Automatically generated constructor for type_face"},
    {"f90wrap_module_structure__type_face_finalise", (PyCFunction)wrap_module_structure_type_face_finalise, METH_VARARGS | \
        METH_KEYWORDS, "Automatically generated destructor for type_face"},
    {"f90wrap_module_structure__type_face__get__type_bn", (PyCFunction)wrap_module_structure__type_face_helper_get_type_bn, \
        METH_VARARGS | METH_KEYWORDS, "Module helper for type_bn"},
    {"f90wrap_module_structure__type_face__set__type_bn", (PyCFunction)wrap_module_structure__type_face_helper_set_type_bn, \
        METH_VARARGS | METH_KEYWORDS, "Module helper for type_bn"},
    {NULL, NULL, 0, NULL}  /* Sentinel */
};

static struct PyModuleDef _type_bnmodule = {
    PyModuleDef_HEAD_INIT,
    "type_bn",
    "Direct-C wrapper for _type_bn module",
    -1,
    _type_bn_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__type_bn(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_type_bnmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
