...
extern void F90WRAP_F_SYMBOL(f90wrap_library__return_array)(int* f90wrap_n0, int* f90wrap_n1, int* m, int* n, int* \
    output);
extern void F90WRAP_F_SYMBOL(f90wrap_library__get__ia)(int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_library__set__ia)(int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_library__array__iarray)(int* dummy_this, int* nd, int* dtype, int* dshape, long \
    long* handle);
...
static PyObject* wrap_library_helper_get_ia(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    ...
    int value;
    F90WRAP_F_SYMBOL(f90wrap_library__get__ia)(&value);
    return Py_BuildValue("i", value);
}

static PyObject* wrap_library_helper_set_ia(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    int value;
    static char *kwlist[] = {"ia", NULL};
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "i", kwlist, &value)) {
        return NULL;
    }
    F90WRAP_F_SYMBOL(f90wrap_library__set__ia)(&value);
    Py_RETURN_NONE;
}

static PyObject* wrap_library_helper_array_iarray(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    ...
    int dshape[10] = {0};
    long long handle = 0;
    F90WRAP_F_SYMBOL(f90wrap_library__array__iarray)(dummy_this, &nd, &dtype, dshape, &handle);
    if (PyErr_Occurred()) {
        return NULL;
    }
    if (nd < 0 || nd > 10) {
...
/* Method table for _ExampleArray_relative module */
static PyMethodDef _ExampleArray_relative_methods[] = {
    ...
    {"f90wrap_library__return_array", (PyCFunction)wrap_library_return_array, METH_VARARGS | METH_KEYWORDS, "Wrapper for \
        return_array"},
    {"f90wrap_library__get__ia", (PyCFunction)wrap_library_helper_get_ia, METH_VARARGS | METH_KEYWORDS, "Module helper for \
        ia"},
    {"f90wrap_library__set__ia", (PyCFunction)wrap_library_helper_set_ia, METH_VARARGS | METH_KEYWORDS, "Module helper for \
        ia"},
    {"f90wrap_library__array__iarray", (PyCFunction)wrap_library_helper_array_iarray, METH_VARARGS | METH_KEYWORDS, "Array \
        helper for iarray"},
...
static struct PyModuleDef _ExampleArray_relativemodule = {
    PyModuleDef_HEAD_INIT,
    "ExampleArray_relative",
    "Direct-C wrapper for _ExampleArray_relative module",
    -1,
    _ExampleArray_relative_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__ExampleArray_relative(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_ExampleArray_relativemodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
