...
def do_array_stuff(n, x, y, br, co, interface_call=False):
    ...
    co : float array
    """
    _ExampleArray_relative.f90wrap_library__do_array_stuff(n=n, x=x, y=y, br=br, \
        co=co)
...
def only_manipulate(n, array, interface_call=False):
    ...
    array : float array
    """
    _ExampleArray_relative.f90wrap_library__only_manipulate(n=n, array=array)
...
def return_array(m, n, output, interface_call=False):
    ...
    output : int array
    """
    _ExampleArray_relative.f90wrap_library__return_array(m=m, n=n, output=output)
...
def get_ia():
    ...
    """
    return _ExampleArray_relative.f90wrap_library__get__ia()

def set_ia(ia):
    _ExampleArray_relative.f90wrap_library__set__ia(ia)
...
def get_array_iarray():
    ...
    array_ndim, array_type, array_shape, array_handle = \
        _ExampleArray_relative.f90wrap_library__array__iarray(f90wrap.runtime.empty_handle)
    ...
    if array_hash in _arrays:
        ...
        try:
            iarray = f90wrap.runtime.get_array(f90wrap.runtime.sizeof_fortran_t,
                                    ...
                                    _ExampleArray_relative.f90wrap_library__array__iarray)
        except TypeError:
