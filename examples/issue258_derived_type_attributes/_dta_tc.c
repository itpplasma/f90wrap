...
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__get_outer_inner)(int* outer, int* ret_inner);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__new_inner)(int* ret_inner, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_inner_finalise)(int* this);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__new_outer)(int* ret_node, int* value, int* inner);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer_finalise)(int* this);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_inner__get__value)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_inner__set__value)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__get__value)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__set__value)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__get__inner)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__set__inner)(int* handle, int* value);
extern void F90WRAP_F_SYMBOL(f90wrap_dta_tc__print__binding__t_inner)(int* inner);

static PyObject* wrap_dta_tc_get_outer_inner(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    int ret_inner[4] = {0};
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__get_outer_inner)(outer, ret_inner);
    if (PyErr_Occurred()) {
...
static PyObject* wrap_dta_tc_new_inner(PyObject* self, PyObject* args, PyObject* kwargs)
{
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__new_inner)(ret_inner, value);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_dta_tc_t_inner_finalise(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_inner_finalise)(this);
    if (this_sequence) {
        Py_DECREF(this_sequence);
    }
    if (this_handle_obj) {
...
static PyObject* wrap_dta_tc_new_outer(PyObject* self, PyObject* args, PyObject* kwargs)
{
    PyObject* py_value = NULL;
    int value_val = 0;
    PyArrayObject* value_scalar_arr = NULL;
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__new_outer)(ret_node, value, inner);
    if (PyErr_Occurred()) {
...
static PyObject* wrap_dta_tc_t_outer_finalise(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_this = NULL;
    static char *kwlist[] = {"this", NULL};
    ...
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer_finalise)(this);
    if (this_sequence) {
        Py_DECREF(this_sequence);
    }
    if (this_handle_obj) {
...
static PyObject* wrap_dta_tc__t_inner_helper_get_value(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    ...
    Py_DECREF(handle_sequence);
    int value;
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_inner__get__value)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
...
static PyObject* wrap_dta_tc__t_inner_helper_set_value(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    int value;
    ...
    Py_DECREF(handle_sequence);
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_inner__set__value)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
    Py_RETURN_NONE;
...
static PyObject* wrap_dta_tc__t_outer_helper_get_value(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    static char *kwlist[] = {"handle", NULL};
    ...
    Py_DECREF(handle_sequence);
    int value;
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__get__value)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
    return Py_BuildValue("i", value);
...
static PyObject* wrap_dta_tc__t_outer_helper_set_value(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    int value;
    ...
    Py_DECREF(handle_sequence);
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__set__value)(this_handle, &value);
    if (PyErr_Occurred()) {
        return NULL;
    }
    Py_RETURN_NONE;
...
static PyObject* wrap_dta_tc__t_outer_helper_get_derived_inner(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_handle;
    static char *kwlist[] = {"handle", NULL};
    ...
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__get__inner)(handle_handle, value_handle);
...
static PyObject* wrap_dta_tc__t_outer_helper_set_derived_inner(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    ...
    Py_DECREF(value_sequence);
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__t_outer__set__inner)(parent_handle, value_handle);
    Py_RETURN_NONE;
}

static PyObject* wrap__dta_tc__print__binding__t_inner(PyObject* self, PyObject* args, PyObject* kwargs)
{
    (void)self;
    PyObject* py_inner = NULL;
    static char *kwlist[] = {"inner", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, "O", kwlist, &py_inner)) {
        return NULL;
    }
    ...
    /* Call f90wrap helper */
    /* Call f90wrap helper */
    F90WRAP_F_SYMBOL(f90wrap_dta_tc__print__binding__t_inner)(inner);
    if (PyErr_Occurred()) {
        if (inner_sequence) Py_DECREF(inner_sequence);
        if (inner_handle_obj) Py_DECREF(inner_handle_obj);
        free(inner);
...
/* Method table for _dta_tc module */
static PyMethodDef _dta_tc_methods[] = {
    {"f90wrap_dta_tc__get_outer_inner", (PyCFunction)wrap_dta_tc_get_outer_inner, METH_VARARGS | METH_KEYWORDS, "Wrapper for \
        get_outer_inner"},
    {"f90wrap_dta_tc__new_inner", (PyCFunction)wrap_dta_tc_new_inner, METH_VARARGS | METH_KEYWORDS, "Wrapper for \
        new_inner"},
    {"f90wrap_dta_tc__t_inner_finalise", (PyCFunction)wrap_dta_tc_t_inner_finalise, METH_VARARGS | METH_KEYWORDS, \
        "Automatically generated destructor for t_inner"},
    {"f90wrap_dta_tc__new_outer", (PyCFunction)wrap_dta_tc_new_outer, METH_VARARGS | METH_KEYWORDS, "Wrapper for \
        new_outer"},
    {"f90wrap_dta_tc__t_outer_finalise", (PyCFunction)wrap_dta_tc_t_outer_finalise, METH_VARARGS | METH_KEYWORDS, \
        "Automatically generated destructor for t_outer"},
    {"f90wrap_dta_tc__t_inner__get__value", (PyCFunction)wrap_dta_tc__t_inner_helper_get_value, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for value"},
    {"f90wrap_dta_tc__t_inner__set__value", (PyCFunction)wrap_dta_tc__t_inner_helper_set_value, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for value"},
    {"f90wrap_dta_tc__t_outer__get__value", (PyCFunction)wrap_dta_tc__t_outer_helper_get_value, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for value"},
    {"f90wrap_dta_tc__t_outer__set__value", (PyCFunction)wrap_dta_tc__t_outer_helper_set_value, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for value"},
    {"f90wrap_dta_tc__t_outer__get__inner", (PyCFunction)wrap_dta_tc__t_outer_helper_get_derived_inner, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for inner"},
    {"f90wrap_dta_tc__t_outer__set__inner", (PyCFunction)wrap_dta_tc__t_outer_helper_set_derived_inner, METH_VARARGS | \
        METH_KEYWORDS, "Module helper for inner"},
    {"f90wrap_dta_tc__print__binding__t_inner", (PyCFunction)wrap__dta_tc__print__binding__t_inner, METH_VARARGS | \
        METH_KEYWORDS, "Binding alias for print"},
    {NULL, NULL, 0, NULL}  /* Sentinel */
};

static struct PyModuleDef _dta_tcmodule = {
    PyModuleDef_HEAD_INIT,
    "dta_tc",
    "Direct-C wrapper for _dta_tc module",
    -1,
    _dta_tc_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__dta_tc(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_dta_tcmodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
