...
/* Method table for _ExampleArray module */
static PyMethodDef _ExampleArray_methods[] = {
...
static struct PyModuleDef _ExampleArraymodule = {
    PyModuleDef_HEAD_INIT,
    "ExampleArray",
    "Direct-C wrapper for _ExampleArray module",
    -1,
    _ExampleArray_methods
};

/* Module initialization */
PyMODINIT_FUNC PyInit__ExampleArray(void)
{
    import_array();  /* Initialize NumPy */
    PyObject* module = PyModule_Create(&_ExampleArraymodule);
    if (module == NULL) {
        return NULL;
    }
    return module;
